...
// import HERO_IMG from "../assets/hero-img.png"; // Fixed typo: 'assests' -> 'assets'
import HERO_IMG from "../assests/hero-img.png";
            ...
            <div className='w-full min-h-full relative z-10 '>
                <div>
                    <section className='flex items-center justify-center -mt-36'>
                        <img src={HERO_IMG} alt="Hero Image" className='w-[80vh] rounded-lg' />
                    </section>
                </div>
